...
function calculateGPA()
{
  ...
  var levelSelect = theForm.elements["level"];
	if(levelSelect[0].checked){var total = 0.1*hs+0.15*alg+0.15*geom+0.3*algii+0.3*recent;}
	if(levelSelect[1].checked){var total = 0.1*hs+0.15*alg+0.3*geom+0.3*algii+0.15*recent;}
